...
Public Class Hosts
    ...
    Private Sub mAdd(NewItem As Host)
        ...
        End Try
    End Sub
    Public Sub Add(NewItem As Host, Parent As SeowHostApp)
        Me.mAdd(NewItem)
    End Sub
    Public Function AddOrGet(HostID As String, Parent As SeowHostApp) As Host
        ...
        End Try
    End Function
    Public Function Add(HostID As String, Parent As SeowHostApp) As Host
